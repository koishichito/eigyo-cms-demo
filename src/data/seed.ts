  ...
  transactions: [
    {
      ...
      agencyRewardJPY: 150_000,
      connectorRewardJPY: 50_000,
      jnaviShareJPY: 800_000,
      allocations: [
        {
          id: 'alloc_tx1_agency',
    ...
    },
    {
      ...
      ratesUsed: { agencyRate: 0.15, connectorRate: 0.05 },
      agencyRewardJPY: 45_000,
      connectorRewardJPY: 15_000,
      jnaviShareJPY: 240_000,
      allocations: [
        {
          id: 'alloc_tx2_agency',
          recipientType: 'ユーザー報酬',
    ...
    },
    {
      ...
      ratesUsed: { agencyRate: 0.15, connectorRate: 0.05 },
      agencyRewardJPY: 15_000,
      connectorRewardJPY: 5_000,
      jnaviShareJPY: 80_000,
      allocations: [
        {
          id: 'alloc_tx3_agency',
          recipientType: 'ユーザー報酬',
  ...
  logs: [
    {
      ...
      action: '売上確定',
      detail: 'deal_001 / 窓ガラスサイネージ / 代理店Aに15%、コネクターBに5%',
      relatedId: 'deal_001',
    },
    {
      id: 'log_002',
      ...
      actorUserId: 'usr_admin',
      action: '売上確定',
      detail: 'deal_002 / JNホテル会員権 / 代理店Aに15%、コネクターAに5%',
      relatedId: 'deal_002',
    },
    {
      id: 'log_003',
      ...
      actorUserId: 'usr_admin',
      action: '売上確定',
      detail: 'deal_003 / 広告枠 / 代理店Bに15%、コネクターCに5%',
      relatedId: 'deal_003',
    },
    {
      id: 'log_004',
